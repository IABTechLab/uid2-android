...
import com.uid2.securesignals.ima.TokenStore;
import com.uid2.securesignals.ima.TokenStoreFactory;
...
public class MyActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    videoPlayer.setMediaController(mediaController);
     TokenStore ts = TokenStoreFactory.getInstance();
     ts.setTokens("test");
...
//              TokenStoreFactory.getInstance().setTokens("test");
